...
namespace device {
  ...
  /**
   * Power meter communication details:
   *
   ...
   * Response to an invalid command starts with a “?” (Hex 0x3F) and ends with a <LF>.
   * When communicating in RS-232, the suffix of the command must also contain a <CR> (Hex 0x0D).
   * The suffix of the response will contain a <CR> as well.
   *
   */
